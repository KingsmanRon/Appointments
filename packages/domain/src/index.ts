...
const allowed: Record<ReferralState, readonly ReferralState[]> = {
  ...
  IDENTITY_PENDING: ["ADMIN_PENDING", "READY", "DISPATCH_PENDING", "REJECTED"],
  ADMIN_PENDING: ["READY", "DISPATCH_PENDING", "REJECTED"],
  READY: ["DISPATCH_PENDING"],
  DISPATCH_PENDING: ["COMPLETED", "RECONCILING", "EXCEPTION"],
